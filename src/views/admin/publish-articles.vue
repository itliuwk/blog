<template>
  <div class="page">
    ...
    <div style="margin: 25px 0;"><quill-editor v-model="content" ref="myQuillEditor" @blur="onEditorBlur($event)" :options="editorOption"></quill-editor></div>

    <el-select style="margin-bottom: 25px" v-model="form.classify" placeholder="请选择文章分类">
      <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
    </el-select>

    <div><el-button type="primary" @click="confirm">确定发布</el-button></div>
  </div>
</template>
